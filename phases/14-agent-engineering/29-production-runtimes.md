...
如果没有 OpenTelemetry GenAI spans（第 23 课）再加上 Langfuse/Phoenix/Opik 后端（第 24 课），你就无法调试一个在第 40 步失败的多步智能体。这对生产环境不是可选项，而是必需品。它决定了你是“快速定位问题”，还是“只能从头重放并加更多日志”。
